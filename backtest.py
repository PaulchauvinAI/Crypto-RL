...
def test(start_date, end_date, ticker_list, data_source, time_interval,
            technical_indicator_list, drl_lib, env,current_working_dir, reward_type,if_vix=True, 
            **kwargs):
...
def main(time_interval = "30m", model_path = "./models/test_ddpg_1m/model", long_period=False, reward_type="normal"):
    TEST_START_DATE, TEST_END_DATE = ('2021-06-19', '2022-06-23') if long_period else ('2021-05-31', '2021-06-11')
